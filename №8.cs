...
public class Writer
{
    string text = "Правила делового этикета в разных странах Правила делового этикета могут отличаться в разных странах. Например, в некоторых странах приветствие осуществляется с помощью рукопожатия, в то время как в других странах принято делать поклон или обмен целыми. Также в разных странах могут быть разные правила поведения за столом, обращения к старшим по возрасту или должности, использования формальных обращений и титулов. Поэтому при ведении деловых переговоров с иностранными партнерами важно знать и учитывать их культурные особенности и правила этикета.";
    int pos_y;
    int cursor = 0;
    Thread thread;
    public Writer() { }
